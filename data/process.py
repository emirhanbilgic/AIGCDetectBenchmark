...
# NOTE:
# The guided_diffusion (DIRE) stack depends on optional packages (e.g. blobfile).
# Import it lazily only when DIRE is used so other methods (e.g. UnivFD) don't
# require those optional dependencies at import time.
...
def get_processing_model(opt):
    if opt.detect_method=='LGrad':
        ...
        from preprocessing_model.guided_diffusion import logger
